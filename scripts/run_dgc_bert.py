...
from models.dgc_bert.dgcbert import DGCBERT
...
def main():
    parser = argparse.ArgumentParser(description="DGCBERT Training and Testing")
    parser.add_argument("--mode", type=str, default="train", choices=["train", "test"], help="Mode: train or test (default: train)")
    parser.add_argument("--model", type=str, default="DGCBERT", help="Model name")
