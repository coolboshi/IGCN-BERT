...
from models.scibert_max.scibert_max import SciBERT_Max
...
def main():
    parser = argparse.ArgumentParser(description="SciBERT_Max Training and Testing")
    
    parser.add_argument("--mode", type=str, default="train", choices=["train", "test"], help="Mode: train or test (default: train)")
    parser.add_argument("--model", type=str, default="scibert_max", help="Model name")
